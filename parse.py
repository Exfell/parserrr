...
async def scrape_all(keywords: list, concurrency: int = 50, query_counts: list = None):  # Уменьшили до 15
    ...
    timeout = aiohttp.ClientTimeout(total=200, connect=30, sock_connect=30, sock_read=60)
